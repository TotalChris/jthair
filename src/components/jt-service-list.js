...
JTServiceListTemplate.innerHTML = `
    ...
    <div class="bg-white mx-auto max-w-max flex flex-row flex-nowrap gap-1 items-center justify-center h-16 tabs tabs-boxed bg-transparent border-black border-4 rounded-2xl !text-black ">
        <div class="btn btn-ghost normal-case border-0 text-black text-lg flex flex-row grow h-full items-center gap-2 bg-jt-yellow pl-2" id="womensBtn"><span class="material-icons">woman</span>Womens</div>
        <div class="btn btn-ghost normal-case border-0 text-black text-lg flex flex-row grow h-full items-center gap-2 pl-2" id="mensBtn"><span class="material-icons">man</span>Mens</div>
        <div class="btn btn-ghost normal-case border-0 text-black text-lg flex flex-row grow h-full items-center gap-2 pl-4" id="kidsBtn"><span class="material-icons">family_restroom</span>Kids</div>
    </div>
    </div>
