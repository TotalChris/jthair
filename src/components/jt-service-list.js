...
JTServiceListTemplate.innerHTML = `
    ...
    <div id="banner" class="pb-16 pt-6 !sticky top-32 z-10 flex" style="background-image: linear-gradient(to bottom, white 55%, transparent 100%)">
		...
		<div class="buttonbar bg-white max-w-max flex h-12 sm:h-16 flex-row flex-nowrap gap-1 items-center justify-center tabs tabs-boxed bg-transparent border-black border-4 rounded-2xl !text-black ">
			<div class="btn btn-ghost min-h-auto normal-case border-0 text-black text-md sm:text-lg flex flex-row grow !min-h-8 h-8 sm:h-full items-center gap-2 bg-jt-grad pl-2" id="womensBtn"><div class="m-icon woman"></div>Womens</div>
			<div class="btn btn-ghost min-h-auto normal-case border-0 text-black text-md sm:text-lg flex flex-row grow !min-h-8 h-8 sm:h-full items-center gap-2 pl-2" id="mensBtn"><div class="m-icon man"></div>Mens</div>
			<div class="btn btn-ghost min-h-auto normal-case border-0 text-black text-md sm:text-lg flex flex-row grow !min-h-8 h-8 sm:h-full items-center gap-2 pl-4" id="kidsBtn"><div class="m-icon family"></div>Kids</div>
		</div>
    </div>
