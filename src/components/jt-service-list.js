...
JTServiceListTemplate.innerHTML = `
    ...
    <div class="bg-white mx-auto max-w-max flex flex-row items-center justify-center h-16 tabs tabs-boxed bg-transparent border-black border-4 rounded-2xl !text-black ">
        <div class="btn btn-ghost normal-case border-0 text-black text-lg flex flex-row grow h-full items-center gap-2 bg-jt-yellow" id="womensBtn">Womens</div>
        <div class="btn btn-ghost normal-case border-0 text-black text-lg flex flex-row grow h-full items-center gap-2" id="mensBtn">Mens</div>
        <div class="btn btn-ghost normal-case border-0 text-black text-lg flex flex-row grow h-full items-center gap-2" id="kidsBtn">Kids</div>
    </div>
    </div>
    ...
    setCategory(category, force){
        ...
        setTimeout(() => {
            ...
            const renderServiceCard = (srv) => {
                ...
                card.setAttribute('price', (srv.isVariable ? '~' : '')+'$'+srv.price);
