...
JTSmartCallEndpointButtonTemplate.innerHTML = `
    ...
    ${(isMobile()?'<a href="tel:8105225028" class="btn btn-ghost text-black bg-jt-grad hover:bg-yellow-200 hover:cursor-pointer normal-case text-lg"><i class="bi bi-telephone"></i>&nbsp;&nbsp;':'<p class="text-black font-bold normal-case text-lg">')}
    (810) 522-5028
    ${(isMobile()?'</a>':'</p>')}
`
