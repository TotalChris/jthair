...
JTStaffCarouselTemplate.innerHTML = `
    <style>${stylesheet}</style>
        ...
        <div class="carousel-item">
            <img src="/assets/team/dana.webp" height="300px" width="300px" class="rounded-full mx-auto opacity-40 transition-opacity select-none" draggable="false" alt="Dana" id="staff-3" data-staffid="3" loading="lazy" />
        </div>
        <div class="carousel-item">
            <img src="/assets/team/kathy.webp" height="300px" width="300px" class="rounded-full mx-auto opacity-40 transition-opacity select-none" draggable="false" alt="Kathy" id="staff-4" data-staffid="4" loading="lazy" />
        </div>
        <div class="carousel-item">
            <img src="/assets/team/krista.webp" height="300px" width="300px" class="rounded-full mx-auto opacity-40 transition-opacity select-none" draggable="false" alt="Krista" id="staff-5" data-staffid="5" loading="lazy" />
        </div>
        <div class="carousel-item">
            <img src="/assets/team/laura.webp" height="300px" width="300px" class="rounded-full mx-auto opacity-40 transition-opacity select-none" draggable="false" alt="Laura" id="staff-6" data-staffid="6" loading="lazy" />
        </div>
        <div class="carousel-item">
            <img src="/assets/team/lauren.webp" height="300px" width="300px" class="rounded-full mx-auto opacity-40 transition-opacity select-none" draggable="false" alt="Lauren" id="staff-7" data-staffid="7" loading="lazy" />
        </div>
        <div class="carousel-item">
            <img src="/assets/team/stephanie.webp" height="300px" width="300px" class="rounded-full mx-auto opacity-40 transition-opacity select-none" draggable="false" alt="Stephanie" id="staff-8" data-staffid="8" loading="lazy" />
        </div>
        <div class="carousel-item" style="padding-right: calc((100% - 300px) / 2)">
            <img src="/assets/team/valerie.webp" height="300px" width="300px" class="rounded-full mx-auto opacity-40 transition-opacity select-none" draggable="false" alt="Valerie" id="staff-9" data-staffid="9" loading="lazy" />
        </div>
    </div>
